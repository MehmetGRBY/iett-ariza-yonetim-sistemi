...
VALUES ('WAITING_TODAYS_TASKS_END', 'Bugünkü Görevlerin Bitmesi Bekleniyor', false, 30, true)
...
ALTER TABLE fault_response_plans
    ...
    (automation_status IN
        ('PENDING', 'WAITING_CURRENT_TASK_END', 'WAITING_TODAYS_TASKS_END',
         'VEHICLE_RETURNING_TO_GARAGE', 'RESOURCE_DEPARTING',
         'RESOURCE_EN_ROUTE', 'RESOURCE_ARRIVED', 'VEHICLE_DELIVERED',
         'TEAM_ASSIGNED', 'WAITING_TEAM', 'DISPATCHED', 'REPAIRING',
